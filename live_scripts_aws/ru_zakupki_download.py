...
SCRIPT_NAME = "ru_zakupki_download"
...
# Base directory
base_directory = r'C:\Users\Administrator\GeC\gecftp\tmp'

# Directories to check or create
directories_to_create = ['zakupki_down_file', 'zakupki_extract_file']
...
for directory in directories_to_create:
    ...
    if not os.path.exists(dir_path):
        ...
        logging.info(f"Directory '{directory}' created at '{base_directory}'.")
    else:
        logging.info(f"Directory '{directory}' already exists at '{base_directory}'.")
