...
try:
    ...
    folders = os.listdir('//13.127.216.250/public/gecftp/tmp/br_conlicitacao_extract_file/br_conlicitacao_2024-03-29-16-28-10')
    for file in folders:
        file_path='//13.127.216.250/public/gecftp/tmp/br_conlicitacao_extract_file/br_conlicitacao_2024-03-29-16-28-10/'+str(file)
